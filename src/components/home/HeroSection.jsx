  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      <div className="absolute inset-0">
        <img src={HERO_IMAGE} alt="Hero" className="w-full h-full object-cover scale-105" />
        ...
        <div className="max-w-3xl">
          ...
          >
            ...
            <h1 className="text-6xl sm:text-7xl lg:text-8xl font-heading font-bold text-foreground tracking-tight leading-[1.0] mb-4">
              <span className="block text-foreground">Best</span>
              <span className="block bg-gradient-to-r from-primary via-yellow-300 to-primary bg-clip-text text-transparent">Account</span>
            </h1>
