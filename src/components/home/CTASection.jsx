      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {[
              { icon: Phone, label: t('cta.phone'), value: '+420 721 075 783', href: 'tel:+420721075783' },
              { icon: Mail, label: t('cta.email'), value: 'office@bestaccount.cz', href: 'mailto:office@bestaccount.cz' },
              { icon: MapPin, label: t('cta.address'), value: 'Wolkerova 1009, Vítkov', href: '/contact' },
